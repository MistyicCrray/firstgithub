...
public interface ProductMapper {
    ...
    @Select({
        ...
        "color, img, userid, hits, min_price, max_price, quality",
        "from product",
        "where id = #{id,jdbcType=VARCHAR}"
    })
    @Results({
        ...
        @Result(column="min_price", property="minPrice", jdbcType=JdbcType.DOUBLE),
        @Result(column="max_price", property="maxPrice", jdbcType=JdbcType.DOUBLE),
