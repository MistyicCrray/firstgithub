...
public interface ProductMapper {
	...
	Integer deleteByPrimaryKey(String proid);
	...
	@Insert({ "insert into product (proid, name, ", "category, price, ", "detail, createdate, ",
			...
			"sellpoint, max_price, ", "quality)", "values (#{proid,jdbcType=VARCHAR}, #{name,jdbcType=VARCHAR}, ",
			...
			"#{sellpoint,jdbcType=VARCHAR}, #{maxPrice,jdbcType=REAL}, ", "#{quality,jdbcType=INTEGER})" })
	...
	@Select({ "select", "proid, name, category, price, detail, createdate, updatedate, createby, updateby, ",
			"color, img, userid, hits, min_price, faver, status, sellpoint, max_price, quality", "from product",
