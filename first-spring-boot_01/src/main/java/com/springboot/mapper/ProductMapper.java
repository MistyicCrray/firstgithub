...
public interface ProductMapper {
     ...
     */
    @Insert({
        "insert into t_product (proid, name, ",
        "category, price, ",
        "detail, createdate, ",
        "updatedate, createby, ",
        "updateby, color, ",
        "img, userid, hits, ",
        "min_price, faver, status, ",
        "sellpoint, max_price, ",
        "quality, isNotAuction, ",
        "increments, currentBidder, ",
        "bidderId, outTime, ",
        "auctionStatus)",
        ...
        "#{bidderid,jdbcType=VARCHAR}, #{outtime,jdbcType=VARCHAR}, ",
    ...
    @Select({
        "select",
        "proid, name, category, price, detail, createdate, updatedate, createby, updateby, ",
        "color, img, userid, hits, min_price, faver, status, sellpoint, max_price, quality, ",
        "isNotAuction, increments, currentBidder, bidderId, outTime, auctionStatus",
        "from t_product",
        "where proid = #{proid,jdbcType=VARCHAR}"
    })
    @Results({
    ...
    @Update({
        ...
        "set name = #{name,jdbcType=VARCHAR},",
          ...
          "isNotAuction = #{isnotauction,jdbcType=VARCHAR},",
          "increments = #{increments,jdbcType=REAL},",
          "currentBidder = #{currentbidder,jdbcType=VARCHAR},",
          "bidderId = #{bidderid,jdbcType=VARCHAR},",
          "outTime = #{outtime,jdbcType=VARCHAR},",
          "auctionStatus = #{auctionstatus,jdbcType=VARCHAR}",
        "where proid = #{proid,jdbcType=VARCHAR}"
    })
