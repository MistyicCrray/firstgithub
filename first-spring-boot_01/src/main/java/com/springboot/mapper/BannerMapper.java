...
public interface BannerMapper {
     ...
     */
    @Insert({
        "insert into t_banner (id, image, ",
        "is_show, is_top, title, ",
        "link_url, create_date, ",
        "update_date, create_by, ",
        "update_by)",
        "values (#{id,jdbcType=VARCHAR}, #{image,jdbcType=VARCHAR}, ",
    ...
    @Select({
        "select",
        "id, image, is_show, is_top, title, link_url, create_date, update_date, create_by, ",
        "update_by",
        "from t_banner",
        "where id = #{id,jdbcType=VARCHAR}"
    })
