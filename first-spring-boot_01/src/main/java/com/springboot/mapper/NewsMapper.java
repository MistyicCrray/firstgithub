...
public interface NewsMapper {
    ...
    @Select({
        "select",
        "id, title, content, sub, createdate, updatedate, createby, updateby, istop",
        "from news",
        "where id = #{id,jdbcType=VARCHAR}"
    })
    @Results({
    ...
    @UpdateProvider(type = com.springboot.entity.dyna.NewsDynaProvider.class, method = "updateProvider")
