...
public interface UserMapper {
    ...
    @Insert({
        ...
        "#{usertype,jdbcType=VARCHAR}, #{activecode,jdbcType=VARCHAR}, ",
        "#{activedate,jdbcType=TIMESTAMP}, #{adreess,jdbcType=VARCHAR}, ",
        "#{tel,jdbcType=VARCHAR}, #{lastlogintime,jdbcType=TIMESTAMP}, ",
    ...
    @Select({
        ...
        "loginname, email, usertype, activeCode, activeDate, adreess, tel, lastLoginTime, ",
        "province, city, area",
        "from user",
        "where id = #{id,jdbcType=VARCHAR}"
    })
