...
public class PublicPayController {
	...
	public void pay(HttpServletRequest request, HttpServletResponse response) throws IOException {
		String backPaySuccseUrl = request.getParameter("backPaySuccseUrl");
		String backPayFailseUrl = request.getParameter("backPayFailseUrl");
		...
		String p0_Cmd = "Buy", p1_MerId = "10001126856", p2_Order = request.getParameter("p2_Order"),
				...
				p8_Url = "http://localhost:8080/day21_2_pay/backServlet", p9_SAF = "", pa_MP = "",
